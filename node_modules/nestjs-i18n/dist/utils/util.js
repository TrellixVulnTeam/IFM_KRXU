...
exports.i18nValidationMessage = exports.i18nValidationErrorFactory = exports.getI18nContextFromArgumentsHost = exports.getI18nServiceFromRpcContext = exports.getI18nServiceFromGraphQLContext = exports.getI18nContextFromRequest = exports.shouldResolve = void 0;
...
function getI18nServiceFromGraphQLContext(graphqlContext) {
    ...
    return new i18n_context_1.I18nContext(ctx.i18nLang, ctx.i18nService);
}
